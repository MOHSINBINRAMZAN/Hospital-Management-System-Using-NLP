...
def run_chat():
    ...
    print("=" * 60)
    print("🏥  HOSPITAL MANAGEMENT SYSTEM - CHATBOT")
    print("=" * 60)
    print("\nWelcome! I'm your Hospital Assistant.")
    print("I can help you with appointments, billing, pharmacy,")
    print("lab tests, emergencies, and much more!")
    ...
    if name_input:
        ...
        print(f"\n🏥 Hospital Assistant: Nice to meet you, {user_name}! How can I help you today?\n")
    else:
        print("\n🏥 Hospital Assistant: Hello! How can I help you today?\n")
    ...
    while True:
        try:
            ...
            if user_input.lower() in ['quit', 'exit', 'bye', 'goodbye']:
                print(f"\n🏥 Hospital Assistant: Goodbye{', ' + user_name if user_name else ''}! Take care and stay healthy! 👋\n")
                break
            ...
            print(f"\n🏥 Hospital Assistant: {response}\n")
            
        except KeyboardInterrupt:
            print(f"\n\n🏥 Hospital Assistant: Goodbye{', ' + user_name if user_name else ''}! Take care! 👋\n")
            break
